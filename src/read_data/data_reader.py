...
def round1_data_reader():
    ...
    trades_r1_d0 = pd.read_csv('data_round1/trades_round_1_day_0_nn.csv')
    trades_r1_d1 = pd.read_csv('data_round1/trades_round_1_day_-1nn.csv')
    trades_r1_d2 = pd.read_csv('data_round1/trades_round_1_day_-2_nn.csv')
